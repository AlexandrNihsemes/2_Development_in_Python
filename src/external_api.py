...
def returns_transaction_amount(transaction: Dict[str, Dict[str, str]]) -> float:
    """
    ...
    if currency == "RUB":
        return round(amount, 2)  # Возвращаем сумму в RUB, округленную до 2 знаков
        ...
        if response.status_code == 200:
            ...
            return round(converted_amount, 2)  # Возвращаем конвертированную сумму, округленную
        else:
...
# Примеры транзакций
transaction_usd: Dict[str, Dict[str, str]] = {"operationAmount": {"amount": "100.0", "currency": {"code": "USD"}}}
transaction_eur: Dict[str, Dict[str, str]] = {"operationAmount": {"amount": "100.0", "currency": {"code": "EUR"}}}
transaction_rub: Dict[str, Dict[str, str]] = {"operationAmount": {"amount": "100.0", "currency": {"code": "RUB"}}}
